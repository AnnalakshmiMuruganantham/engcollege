! function(e) {
    ...
    h.prototype = {
        ...
        open: function(i) {
            ...
            b("BeforeOpen"), t.st.showCloseBtn && (t.st.closeBtnInside ? (y(c, function(e, t, i, n) {
                i.close_replaceWith = w(n.type)
            }), r += " mfp-close-btn-in") : t.wrap.append(w())), t.st.alignTop && (r += " mfp-align-top"), t.fixedContentPos ? t.wrap.css({
            ...
            return t.isIE7 && (v += " mfp-ie7"), v && t._addClassToMFP(v), t.updateItemHTML(), b("BuildControls"), e("html").css(g), t.bgOverlay.add(t.wrap).prependTo(t.st.prependTo || e(document.body)), t._lastFocusedEl = document.activeElement, setTimeout(function() {
        ...
        updateItemHTML: function() {
            ...
            if (b("BeforeChange", [t.currItem ? t.currItem.type : "", n]), t.currItem = i, !t.currTemplate[n]) {
                ...
                b("FirstMarkupParse", r), r ? t.currTemplate[n] = e(r) : t.currTemplate[n] = !0
            }
            o && o !== i.type && t.container.removeClass("mfp-" + o + "-holder");
            var a = t["get" + n.charAt(0).toUpperCase() + n.slice(1)](i, t.currTemplate[n]);
            t.appendContent(a, n), i.preloaded = !0, b(d, i), o = i.type, t.container.prepend(t.contentContainer), b("AfterChange")
        },
        ...
        _checkIfClose: function(i) {
            if (!e(i).hasClass(g)) {
                ...
                if (n && o || !t.content || e(i).hasClass("mfp-close") || t.preloader && i === t.preloader[0]) return !0;
        ...
        if ("string" == typeof i) {
            if ("open" === i) {
                var o, r = v ? n.data("magnificPopup") : n[0].magnificPopup,
            ...
            getInline: function(i, n) {
                if (T(), i.src) {
                    ...
                    if (r.length) {
                        ...
                        a && a.tagName && (k || (k = C(_ = o.hiddenClass), _ = "mfp-" + _), P = r.after(k).detach().removeClass(_)), t.updateStatus("ready")
    ...
    e.magnificPopup.registerModule(z, {
        ...
        proto: {
            initAjax: function() {
                t.types.push(z), E = t.st.ajax.cursor, y(s + "." + z, M), y("BeforeChange." + z, M)
            },
            getAjax: function(i) {
    ...
    e.magnificPopup.registerModule("image", {
        ...
        proto: {
            initImage: function() {
                var i = t.st.image,
                    n = ".image";
                t.types.push("image"), y(p + n, function() {
                    "image" === t.currItem.type && i.cursor && e(document.body).addClass(i.cursor)
                }), y(s + n, function() {
                    i.cursor && e(document.body).removeClass(i.cursor), $.off("resize" + u)
                ...
                var i = 0,
                    ...
                    o = function(r) {
                        B && clearInterval(B), B = setInterval(function() {
                            ...
                            i > 200 && clearInterval(B), 3 == ++i ? o(10) : 40 === i ? o(50) : 100 === i && o(500)
                        }, r)
                    };
                o(1)
            },
            getImage: function(i, n) {
                var o = 0,
                    r = function() {
                        i && (i.img[0].complete ? (i.img.off(".mfploader"), i === t.currItem && (t._onImageHasSize(i), t.updateStatus("ready")), i.hasSize = !0, i.loaded = !0, b("ImageLoadComplete")) : ++o < 200 ? setTimeout(r, 100) : a())
                    },
                    a = function() {
    ...
    e.magnificPopup.registerModule(F, {
        ...
        proto: {
            initIframe: function() {
                t.types.push(F), y("BeforeChange", function(e, t, i) {
                    t !== i && (t === F ? A() : i === F && A(!0))
                }), y(s + "." + F, function() {
                    A()
                })
